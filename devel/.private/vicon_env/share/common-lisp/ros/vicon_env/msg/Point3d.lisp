...
(cl:defmethod cl:initialize-instance :after ((m <Point3d>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Point3d)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name vicon_env-msg:<Point3d> is deprecated: use vicon_env-msg:Point3d instead.")))
...
(cl:defmethod z-val ((m <Point3d>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vicon_env-msg:z-val is deprecated.  Use vicon_env-msg:z instead.")
  (z m))
